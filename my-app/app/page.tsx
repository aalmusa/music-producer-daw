  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col items-center justify-center gap-12 px-4 text-center relative z-10 min-h-screen'>
        <h1
          className={`${montserrat.className} max-w-3xl text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-tight`}
        >
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4'>
          <Link href='/chat'>
            <Button
              size='lg'
              className='cursor-pointer text-base sm:text-lg px-8 py-6 bg-white text-black hover:bg-white/90 rounded-full font-medium shadow-lg'
            >
              Get Started
            </Button>
          </Link>
